...
{
    $lat = array('a', 'c', 'e', 'o', 'n', 'p', 'x', 'u', 'y', 'b', 'h', 'k', 'm', 't', 'μ', 'à', 'á', 'α', 'â', 'ã', 'ä', 'å', 'ā', 'ă', 'ą', 'ò', 'ó', 'ô', 'õ', 'ö', 'ć', 'ĉ', 'ċ', 'č', 'ē', 'ĕ', 'ė', 'ę', 'ě', 'è', 'é', 'ê', 'ά', 'ᾁ', 'ᾉ', 'ⱪ', 'ό');
    $cyr = array('а', 'с', 'е', 'о', 'п', 'р', 'х', 'и', 'у', 'в', 'н', 'к', 'м', 'т', 'м', 'а', 'а', 'а', 'а', 'а', 'а', 'а', 'а', 'а', 'а', 'о', 'о', 'о', 'о', 'о', 'с', 'с', 'с', 'с', 'е', 'е', 'е', 'е', 'е', 'е', 'е', 'е', 'а', 'а', 'а', 'к', 'о');
