...
<?php $arc_checked[$set['arc']] = 'checked'; ?>
	...
	<p title="Or just add the string to crontab file to run each 10 minutes. If ypu don't see a full path to file use full path instead.">*/10  *  *  *  * <?php echo exec('whoami'); ?> /usr/bin/php <?= dirname(__file__); ?>/search_bad_ads.php</p>
